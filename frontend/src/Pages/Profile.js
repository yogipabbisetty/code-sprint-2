...
const AppHeader = ({ email, handleLogout }) => {
  return (
    <AppBar position="static" sx={{background:`linear-gradient(90deg, rgb(1, 99, 92) 20%, rgb(7, 206, 207) 100%)`}}>
...
export default function Profile() {
  ...
  return (
    <>
      ...
      <ResponsiveDrawer header={<AppHeader email={Email} handleLogout={handleLogout} />} children={<ProfileForm/>}/>
